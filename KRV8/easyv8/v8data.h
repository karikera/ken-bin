...
namespace kr
{
	...
	public:
		...
		// 객체에 클래스를 집어넣습니다
		// 예외: JsException
		KR_EASYV8_DLLEXPORT void setClass(Text16 name, V8Handle<v8::FunctionTemplate> * value);

		// 객체에 변수를 집어넣습니다
		KR_EASYV8_DLLEXPORT void set(Text16 name, JsAny value);

		// 객체에 변수를 가져옵니다
		KR_EASYV8_DLLEXPORT JsAny get(Text16 name) const;

		// 객체에서 변수를 지웁니다.
		KR_EASYV8_DLLEXPORT bool remove(Text16 name) const;
