...
namespace kr
{
	namespace math
	{
		...
		{
			return quaternionT(std::sinf(rad / 2.f), 0, 0, std::cosf(rad / 2.f));
		}
		template <bool aligned>
		inline const quaternionT<aligned> quaternionT<aligned>::rotateY(float rad) noexcept
		{
			return quaternionT(0, std::sinf(rad / 2.f), 0, std::cosf(rad / 2.f));
		}
		template <bool aligned>
		inline const quaternionT<aligned> quaternionT<aligned>::rotateZ(float rad) noexcept
		{
			return quaternionT(0, 0, std::sinf(rad / 2.f), std::cosf(rad / 2.f));
		}
		template <bool aligned>
